...
public class UserController {
        ...
        .map(
            activityWithStatus ->
                toUserActivityResponse(
                    activityWithStatus.activity(), activityWithStatus.attendanceStatus()))
        .toList();
  }
  ...
  private static UserLookupResponse toResponse(UserLookupResult user) {
    return new UserLookupResponse(user.id(), user.name(), user.email());
  }
  ...
  private static UserActivityResponse toUserActivityResponse(
      Activity activity, String attendanceStatus) {
