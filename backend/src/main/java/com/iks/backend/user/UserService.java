...
public class UserService {
  ...
  public void createActivityInviteNotifications(
    ...
    List<UserNotification> notifications =
        keycloakService.listGroupMembers(groupId).stream()
  ...
  public List<UserNotification> listMyUnreadNotificationsAndMarkRead() {
    ...
    List<String> notificationIds = notifications.stream().map(UserNotification::getId).toList();
  ...
  private String getCurrentUserId() {
    ...
    if (principal instanceof Jwt jwt) {
      ...
      if (userId == null || userId.isBlank()) {
        throw new InvalidUserSearchRequestException(
